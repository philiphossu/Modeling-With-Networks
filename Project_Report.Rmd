...
```{r, echo=TRUE}
biggestCliquesFound <- largest_cliques(erdos1_network) # List of biggest cliques
...
```{r}
transitivity(erdos1_network) # Show the clustering coefficient calculation result
```
